  ...
  return (
    <Flex className="relative flex-1">
      ...
      <Flex className="z-10 flex-1 flex-col gap-3 p-10 max-lg:p-5">
        ...
        <Center>
          <Text className="text-baseline text-6xl tracking-[0.25em] text-iaplus-blue max-lg:text-4xl">
            IA
            <em className="font-intro font-bold not-italic">PLUS</em>
          </Text>
        </Center>
        <Flex className="items-center pb-16 max-lg:flex-col">
          <Flex className="flex-1 flex-col gap-4 pt-8">
            <Text className="font-body text-3xl font-medium max-lg:text-center max-lg:text-xl ">
